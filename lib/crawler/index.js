...
class Crawler extends EventEmitter {
  ...
  async init () {
    ...
    if (!wasError) {
      ...
      // this.requestMonitor.withRequestMonitoring(this._client.Network, this._navMan)
      this.emit('connected')
    }
  }
  ...
  static Protocol (...args) {
    return CRI.Protocol(...args)
  }

  static List (...args) {
    return CRI.List(...args)
  }
  ...
  static Activate (...args) {
    return CRI.Activate(...args)
  }

  static Close (...args) {
    return CRI.Close(...args)
  }

  static Version (...args) {
    return CRI.Version(...args)
  }
}
