 ...
 * @property {string}  [use = chrome]     - Should Squidwarc use bare Chrome/Chromium or puppeteer
 * @property {boolean} [headless = true]  - Should the browser used by Squidwarc be launched in headless mode
 * @property {string} [executablePath]    - Path to the browser executable or command to be use to launch the browser
 ...
 * @property {ConnectOptions} [connect]   - Options for launching/connecting to the Chrome/Chromium browser
