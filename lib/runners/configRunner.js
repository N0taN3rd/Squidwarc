...
async function configRunner (configPath) {
  ...
  conf.timeouts.navigationTimeout =
    conf.timeouts.navigationTimeout || defaults.defaultOpts.timeouts.navigationTimeout
  conf.timeouts.waitAfterLoad =
    conf.timeouts.waitAfterLoad || defaults.defaultOpts.timeouts.waitAfterLoad
  conf.versionInfo = defaults.defaultOpts.versionInfo
  conf.versionInfo.isPartOfV =
    conf.isPartOfV || defaults.defaultOpts.versionInfo.isPartOfV
  conf.versionInfo.warcInfoDescription =
    conf.warcInfoDescription || defaults.defaultOpts.versionInfo.warcInfoDescription
