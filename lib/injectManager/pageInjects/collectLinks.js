...
/**
 * @desc Starts the collection of the outlinks. Use only when {@link init} is pre-injected into every frame
 */
function collect () {
...
/**
 *
 * @type {{init: init, collect: (function()), outLinks: (function(): {outlinks: string, links: Array})}}
 */
module.exports = {
  init,
  collect,
